...
$.extend(SVGManager.prototype, {
	...
	_attrNames: {class_: 'class', in_: 'in',
		...
		floodOpacity: 'flood-opacity', fontFamily: 'fonts-family',
		fontSize: 'font-size', fontSizeAdjust: 'fonts-size-adjust',
		fontStretch: 'fonts-stretch', fontStyle: 'fonts-style',
		fontVariant: 'fonts-variant', fontWeight: 'fonts-weight',
...
$.extend(SVGWrapper.prototype, {
	...
	/* Add a style node.
	   ...
	   @param  stylesLanding    (string) the CSS stylesLanding
